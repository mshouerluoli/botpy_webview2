...
namespace RestClient
{
	 ...
	 inline Request default_request;

	 inline Response get(const std::string& url, Request* request = nullptr) {
	 ...
	 inline Response post(const std::string& url, const std::string& content_type, const std::string& data, Request* request = nullptr) {
	 ...
	 inline Response put(const std::string& url, const std::string& content_type, const std::string& data, Request* request = nullptr) {
	 ...
	 inline Response del(const std::string& url, Request* request = nullptr) {
	 ...
	 inline Response head(const std::string& url, Request* request = nullptr) {
